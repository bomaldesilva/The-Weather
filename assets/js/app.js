...
export const updateWeather = (lat,lon)=>{
    ...
    fetchData(url.currentWeather(lat,lon),(currentWeather)=>{
        ...
        fetchData(url.airPollution(lat,lon),(airPollution)=>{
            ...
            card.innerHTML=`
            <h2 class="title-2" id="highlights-lable">Today Highlights</h2><br>
            ...
            var xyValues = [
              ...
              new Chart("myChart2", {
                ...
                options: {
                  ...
                  scales: {
                    xAxes: [{ticks: {min: 2.30, max:23.30}}],
                    yAxes: [{ticks: {min: -15, max:58}}],
                  }
                }
              })
              ...
              const data = google.visualization.arrayToDataTable([
                ...
                ['Rain',55],
                ['Foggy',23],
                ['Thunder',14.5],['OverCast',14.5],['Extra Sunny',90]
              ]);
              const options = {
                title:'World Wide Weather Condition',
                is3D:true,
